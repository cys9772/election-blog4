...
kable(cor_results, caption = "Correlation between GDP Growth and Incumbent Vote Share")
```
...
kable(predictions, caption = "Predicted Vote Share for 2024 based on Different Models")
```
